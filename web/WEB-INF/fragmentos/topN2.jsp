...
<head>
    ...
    <script src="../../sicoe/recursos/plugins/jquery/jquery-1.12.4.js"></script>
    <script src="../../sicoe/recursos/plugins/moment/moment-with-locales.js"></script>
    <script src="../../sicoe/recursos/plugins/bootstrap/datetimepicker/js/bootstrap-datetimepicker.js"></script>
    <script src="../../sicoe/recursos/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
    <link href="../../sicoe/recursos/plugins/bootstrap/datetimepicker/css/bootstrap-datetimepicker.css">
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="repAsis" class="collapse">
                            <li>
                                <a href="./redirect.evt?rd=rpasis">Reporte Inscritos</a>
                            </li>
                            <li>
                                <a href="./redirect.evt?rd=rpa">Reporte Asistente</a>
                            </li>
                            <li>
                                <a href="./redirect.evt?rd=rpia">Reporte Inasistente</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#creaAsis"><i class="fa fa-cog"></i> Mantenimiento <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="creaAsis" class="collapse">
                            <li>
                                <a href="./redirect.evt?rd=casis">Crear Asistencia</a>
                            </li>
                            <li>
                                <a href="./redirect.evt?rd=gesasis">Gestionar Asistencia</a>
                            </li>
                        </ul>
                    </li>                
                </ul>
