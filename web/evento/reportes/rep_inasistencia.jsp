...
<jsp:useBean id="reporteInasistente" scope="request" type="java.util.List<EventosViewBean>"/>
               <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header">
                            Reportes
                            <small>Reporte de inasistencia</small>
                        </h4>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <table class="table table-bordered table-hover table-striped tabla-rep">
                                ...
                                <tbody>
                                    <%
                                        String row = "danger";
                                        int count = 0;
                                      for(EventosViewBean ev: reporteInasistente){
                                          count++;
