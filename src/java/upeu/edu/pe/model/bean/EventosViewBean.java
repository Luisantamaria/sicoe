...
public class EventosViewBean {
    ...
    public EventosViewBean() {
    }

    public EventosViewBean(Integer idasistente, String voucher, String operacion, Date fecha, String carne, String nombres, String apellidoPat, String apellidoMat, String dni, String ep, Double importe, Integer idevento, Integer idorganizador_ev, String evento, Date fechaInicio, Date fechaFin, Character estado_evt, Integer ideventoSesion, Integer idevento_evs, String sesion, Date fechaEvento, Date hora, String descripcion, Character estado_evs, Integer idasistente_cea, Integer ideventoSesion_cea, char estado_cea, String estado_reg_cea, Integer idorganizador, String organizador, String responzable) {
